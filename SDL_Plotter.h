...
public:
    ...
    void plotMario(int sprite);
    void SpriteStatus(char);
...
void gravity(int ycord, int windh, int recth){
    ycord = min(ycord + 1, windh-recth);
}
void SDL_Plotter::plotMario(int sprite) {
    ifstream in;
    SDL_Plotter f;
    //bool stoptitle = true;
    int R,G,B, xd =0, yd =0;
